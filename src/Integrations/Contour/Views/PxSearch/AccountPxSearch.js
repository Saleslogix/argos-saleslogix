...
import CultureInfo from 'argos/CultureInfo';
...
const __class = declare('crm.Integrations.Contour.Views.PxSearch.AccountPxSearch', [_ListBase, _LegacyListBase, _CardLayoutListMixin], {
  ...
  distanceText: function() {
	...
	distanceCalc: function(gLat, gLon) {
  ...
  resourceKind: 'accounts',
	...
	geoLocationReceived: function(position) {
  ...
  hasMoreData: function() {
	...
	formatSearchQuery: function(qry) {
