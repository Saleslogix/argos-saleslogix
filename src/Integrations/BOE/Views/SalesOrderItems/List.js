...
const __class = declare('crm.Integrations.BOE.Views.SalesOrderItems.List', [List, _RightDrawerListMixin, _MetricListMixin, _CardLayoutListMixin], {
  ...
  itemTemplate: new Simplate([
    ...
    '{% } %}',
    '{% if ($.SlxLocation) { %}',
    '<p class="listview-subheading"><label class="group-label">{%: $$.warehouseText %}</label> {%: $.SlxLocation.Description %}</p>',
    '{% } %}',
    '<p class="listview-subheading"><label class="group-label">{%: $$.productNameText %}</label> {%: $.ProductName %}</p>',
    '<p class="listview-subheading"><label class="group-label">{%: $$.descriptionText %}</label> {%: $.Description %}</p>',
    '<p class="listview-subheading"> <label class="group-label">{%: $$.priceText %}</label> ',
    '{%: $$.util.formatMultiCurrency($.Price, $.SalesOrder.BaseCurrencyCode) %}',
    '</p>',
    '<p class="listview-subheading"> <label class="group-label">{%: $$.adjustedPriceText %}</label> ',
    '{%: $$.util.formatMultiCurrency($.DocCalculatedPrice, $.SalesOrder.CurrencyCode) %}',
    '</p>',
    '<p class="listview-subheading"> <label class="group-label">{%: $$.baseAdjustedPriceText %}</label> ',
    ...
    '<p class="listview-subheading"> <label class="group-label">{%: $$.baseAmountText %}</label> ',
    '{%: $$.util.formatMultiCurrency($.ExtendedPrice, $.SalesOrder.BaseCurrencyCode) %}',
    '</p>',
    '<p class="listview-subheading"> <label class="group-label">{%: $$.amountText %}</label> ',
