...
define('Mobile/SalesLogix/Views/Account/Edit', ['Sage/Platform/Mobile/Edit'], function() {
    ...
    return dojo.declare('Mobile.SalesLogix.Views.Account.Edit', [Sage.Platform.Mobile.Edit], {
        ...
        typeText: 'type',
        webText: 'web',
        noAccessEditText: "You don't have access to Edit Accounts",
        noAccessAddText: "You don't have access to Add Accounts",

        //View Properties
        entityName: 'Account',
        id: 'account_edit',
        securedAction: { add: 'Entities/Account/Add', edit: 'Entities/Account/Edit' },
        querySelect: [
