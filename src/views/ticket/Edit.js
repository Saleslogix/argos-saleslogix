    ...
    constructor: function(o) {
       ...
       Ext.apply(this, o, {
        ...
        this.layout = [
            ...
            {name: 'Issue', label: this.issueText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "Ticket Issue"', title: 'Ticket Issue'},
            {name: 'Source', label: this.sourceText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "Source"', title: 'Source', orderBy: 'sort asc'},
            {name: 'StatusCode', label: this.statusText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "Ticket Status"', title: 'Ticket Status', orderBy: 'sort asc'},
            {name: 'UrgencyCode', label: this.urgencyText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "TicketUrgency"', title: 'Ticket Urgency'},
