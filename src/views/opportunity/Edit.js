...
Mobile.SalesLogix.Opportunity.Edit = Ext.extend(Sage.Platform.Mobile.Edit, {
    ...
    constructor: function(o) {
        ...
        this.layout = [
            ...
            {name: 'Type', label: this.typeText, type: 'pickup', view: 'opp_type_pick_list', resourcePredicate: 'name eq "Opportunity Type"', title: 'Opportunity Type'},
            {name: 'Status', label: this.statusText, type: 'pickup', view: 'opp_status_pick_list', resourcePredicate: 'name eq "Opportunity Status"', title: 'Opportunity Status'},
            ...
            {name: 'CloseProbability', label: this.probabilityText, type: 'pickup', view: 'opp_close_probability_pick_list', resourcePredicate: 'name eq "Opportunity Probability"', title: 'Opportunity Probability'},
        ];
    },
    init: function() {
