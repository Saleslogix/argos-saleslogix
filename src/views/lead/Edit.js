...
Mobile.SalesLogix.Lead.Edit = Ext.extend(Sage.Platform.Mobile.Edit, {
    ...
    constructor: function(o) {
        ...
        this.layout = [
            ...
            {name: 'Title', label: this.titlText, type: 'pickup', view: 'lead_title_pick_list', resourcePredicate: 'name eq "Title"', title: 'Title'},
            ...
            {name: 'Industry', label: this.industryText, type: 'pickup', view: 'lead_industry_pick_list', resourcePredicate: 'name eq "Industry"', title: 'Industry'},
