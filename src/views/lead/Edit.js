...
Mobile.SalesLogix.Lead.Edit = Ext.extend(Sage.Platform.Mobile.Edit, {
    ...
    constructor: function(o) {
        ...
        this.layout = [
            ...
            {name: 'Industry', label: this.industryText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "Industry"', textProperty: 'text', title: 'Industry'},
            {name: 'City', label: this.cityText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "City"', textProperty: 'text', title: 'City'},
