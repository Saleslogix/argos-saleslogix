...
Mobile.SalesLogix.AddressEdit = Ext.extend(Sage.Platform.Mobile.Edit, {
    ...
    constructor: function(o) {
        ...
        this.layout = [
            ...
            {name: 'City', label: this.cityText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "City"', title: 'City', alwaysUseValue: true},
            {name: 'State', label: this.stateText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "State"', title: 'State', alwaysUseValue: true},
            {name: 'PostalCode', label: this.postalCodeText, type: 'text', alwaysUseValue: true},
            {name: 'Country', label: this.countryText, type: 'pickup', view: 'pick_list', resourcePredicate: 'name eq "Country"', title: 'Country', alwaysUseValue: true},
