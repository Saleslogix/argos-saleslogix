...
Mobile.SalesLogix.Account.Edit = Ext.extend(Sage.Platform.Mobile.Edit, {
    ...
    constructor: function(o) {
        ...
        this.layout = [
            ...
            {name: 'Type', label: this.typeText, type: 'pickup', view: 'pick_list', textProperty: 'text', resourcePredicate: 'name eq "Account Type"', textProperty: 'text', title: 'Account Type'},
            {name: 'SubType', label: this.subTypeText, type: 'text'},
            {name: 'Status', label: this.statusText, type: 'pickup', view: 'pick_list', textProperty: 'text', resourcePredicate: 'name eq "Account Status"', textProperty: 'text', title: 'Account Status'},
