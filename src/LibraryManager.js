 ...
 * Attatchment Manager 
 */
define('Mobile/SalesLogix/LibraryManager', [
    ...
    return declare('Mobile.SalesLogix.LibraryManager', null, {
        _fileManager: null,
        _entityContext: null,
        _uploadUrl: '',
        _baseUrl: '',
        ...
        constructor: function() {
            ...
            this._uploadUrl = this._baseUrl + '/libraryDocuments/file';
            service.setContractName(oldContractName);            
        },
        AddFile: function(file, mixin) {
        ...
        AddFolder: function(file, mixin) {
            
        },
        _getDefaultDescription: function(filename) {
            return filename.replace(/\.[\w]*/, '');
        },
        getFileTemplate: function(callback) {
        ...
        getFileUrl: function(fileId) {
            var fileUrl = this._baseUrl + '/libraryDocuments(\'' + fileId + '\')/file';
            return fileUrl;
        },
       _getFileDescription: function(fileName) {
        ...
        getFile: function(fileId, responseType, onSuccsess) {
             var url, fm;
