...
localize("Mobile.SalesLogix.Views.Activity.Detail", {
  ...
  "locationText": "Месторасположение",
...
localize("Mobile.SalesLogix.Views.Contact.List", {
  ...
  "hashTagQueriesText": {
    ...
    "can-email": "По-e-mail",
    "can-phone": "По-телефону",
    "can-fax": "По-факсу",
    "can-mail": "По-почте",
    "can-solicit": "Можно-беспокоить"
  }
});
