define("crm/PicklistService", ["exports", "dojo/_base/lang", "argos/ErrorManager", "argos/Store/SData"], function (_exports, _lang, _ErrorManager, _SData) {
  "use strict";
   ...
   */
  var PickListService = ICRMServicesSDK.PickListService;
  ...
  var __class = _lang["default"].setObject('crm.PicklistService',
  /** @lends module:crm/PicklistService */
  {
    _picklists: {},
    ...
    getPicklistByName: function getPicklistByName(name, languageCode) {
      if (languageCode) {
        var picklist = this._picklists["".concat(name, "_").concat(languageCode)];
    ...
    format: function format(picklistCode
    /* , storageMode */
    ) {
    ...
    onPicklistSuccess: function onPicklistSuccess(resolve, languageCode) {
      ...
      return function (result) {
        ...
        if (result && result.items) {
          ...
          if (languageCode) {
            _this2._picklists["".concat(picklist.name, "_").concat(languageCode)] = picklist;
          } else {
    ...
    onPicklistError: function onPicklistError(reject, name) {
      ...
      return function (response, o) {
        ...
        _ErrorManager["default"].addError(response, o, null, 'failure');
    ...
    requestPicklist: function requestPicklist(name) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var first = _this4.service.getFirstByName(name, _this4.onPicklistSuccess(resolve, language), _this4.onPicklistError(reject, name), {
          pickListServiceOptions: pickListServiceOptions,
          language: language,
          useCache: useCache
        });
  ...
  _lang["default"].setObject('crm.Integrations.BOE.PicklistService', __class);
