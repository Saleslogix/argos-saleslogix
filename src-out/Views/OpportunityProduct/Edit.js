define("crm/Views/OpportunityProduct/Edit", ["exports", "dojo/_base/declare", "../../Validator", "argos/Edit", "argos/Utility", "argos/I18n"], function (_exports, _declare, _Validator, _Edit, _Utility, _I18n) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('opportunityProductEdit');
  ...
  var __class = (0, _declare["default"])('crm.Views.OpportunityProduct.Edit', [_Edit["default"]], {
    ...
    getValues: function getValues() {
      ...
      delete o.CalculatedPriceMine; // transform the discount back into a decimal
      ...
      var details = {
        ...
        children: [{
          ...
          where: function where() {
            ...
            return "Product.Name eq \"".concat(_Utility["default"].escapeSearchQuery(val.Name), "\"");
          }.bindDelegate(this)
        }, {
