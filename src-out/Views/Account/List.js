define('crm/Views/Account/List', ['exports', 'module', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/string', '../../Action', 'argos/Utility', 'argos/List', '../_GroupListMixin', '../_MetricListMixin', '../_CardLayoutListMixin', '../_RightDrawerListMixin', '../../OfflineManager'], function (exports, module, _dojo_baseDeclare, _dojo_baseLang, _dojoString, _Action, _argosUtility, _argosList, _GroupListMixin2, _MetricListMixin2, _CardLayoutListMixin2, _RightDrawerListMixin2, _OfflineManager) {
  ...
  var __class = (0, _declare['default'])('crm.Views.Account.List', [_List['default'], _RightDrawerListMixin3['default'], _MetricListMixin3['default'], _CardLayoutListMixin3['default'], _GroupListMixin3['default']], {
    ...
    onTransitionTo: function onTransitionTo() {
      _OfflineManager2['default'].getAllIds().then((function success(results) {
