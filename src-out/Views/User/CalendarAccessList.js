define("crm/Views/User/CalendarAccessList", ["exports", "dojo/_base/declare", "argos/List", "argos/I18n"], function (_exports, _declare, _List, _I18n) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('userCalendarAccessList');
  ...
  var __class = (0, _declare["default"])('crm.Views.User.CalendarAccessList', [_List["default"]], {
    ...
    queryWhere: function queryWhere() {
      return "AllowAdd AND (AccessId eq 'EVERYONE' or AccessId eq '".concat(App.context.user.$key, "') AND Type eq 'User'");
    },
