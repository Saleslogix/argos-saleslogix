define('crm/Views/_DashboardWidgetBase', ['exports'], function (exports) {
    /*
     * See copyright file.
     */

    define('crm/Views/_DashboardWidgetBase', ['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/event', 'dojo/on', 'dojo/string', 'dojo/dom-class', 'dojo/when', 'dojo/promise/all', 'dojo/_base/Deferred', 'dojo/dom-construct', 'dojo/query', 'dojo/dom-attr', 'dojo/_base/connect', 'dojo/_base/array', 'argos/Utility', 'argos/Format', 'crm/Format', 'argos/Convert', 'moment', 'argos/RelatedViewManager', 'argos/_RelatedViewWidgetBase', 'crm/Action', 'argos/Store/SData', 'crm/Views/MetricWidget', 'crm/Views/DateRangeWidget'], function (declare, lang, event, on, string, domClass, when, all, Deferred, domConstruct, query, domAttr, connect, array, utility, format, crmFormat, convert, moment, RelatedViewManager, _RelatedViewWidgetBase, action, SData, MetricWidget, DateRangeWidget) {
        var __class = declare('crm.Views._DashboardWidgetBase', [_RelatedViewWidgetBase], {
            ...
            */
            ...
            pastDays: function pastDays(property, from, to) {
                ...
                query = string.substitute('((' + property + ' between @${0}@ and @${1}@) or (' + property + ' between @${2}@ and @${3}@))', [convert.toIsoStringFromDate(pastWeekStart.toDate()), convert.toIsoStringFromDate(today.toDate()), pastWeekStart.format('YYYY-MM-DDT00:00:00[Z]'), today.format('YYYY-MM-DDT23:59:59[Z]')]);
                return query;
            },
            /**
            ...
            pastDaysLt: function pastDaysLt(property) {
                ...
                query = string.substitute('(' + property + ' lt @${0}@ or (' + property + ' lt @${1}@))', [convert.toIsoStringFromDate(pastDay.toDate()), pastDay.format('YYYY-MM-DDT00:00:00[Z]')]);
                return query;
            },
