...
], function (declare, lang, string, connect, array, format, domConstruct, domAttr, domClass, has, dom, domGeom, AttachmentManager, Utility, Detail, _LegacySDataDetailMixin) {
