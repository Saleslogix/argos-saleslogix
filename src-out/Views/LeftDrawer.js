define("crm/Views/LeftDrawer", ["exports", "dojo/_base/declare", "dojo/_base/lang", "dojo/store/Memory", "../SpeedSearchWidget", "dojo/string", "argos/GroupedList", "argos/I18n"], function (_exports, _declare, _lang, _Memory, _SpeedSearchWidget, _string, _GroupedList, _I18n) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('leftDrawer');
  ...
  var __class = (0, _declare["default"])('crm.Views.LeftDrawer', [_GroupedList["default"]], {
    ...
    createLayout: function createLayout() {
      ...
      var footer = {
        ...
        children: [{
          ...
          title: _string["default"].substitute(this.connectionText, {
            connectionStatus: App.onLine ? this.onlineText : this.offlineText
          }),
          enableOfflineSupport: true
        }, {
          name: 'AboutAction',
    ...
    showAbout: function showAbout() {
      $('body').about({
        ...
        content: "<p>".concat(this.currentUserText, " ").concat(App.context.user.$descriptor, "</p>")
      });
    },
