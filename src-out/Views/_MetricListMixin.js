define("crm/Views/_MetricListMixin", ["exports", "dojo/_base/declare", "./MetricWidget", "../GroupUtility"], function (_exports, _declare, _MetricWidget, _GroupUtility) {
  "use strict";
  ...
  /** @lends module:crm/Views/_MetricListMixin.prototype */
  {
    // Metrics
    ...
    metricWidgetCtor: _MetricWidget["default"],
    ...
    _applyStateToWidgetOptions: function _applyStateToWidgetOptions(options) {
      ...
      if (this.groupsMode) {
        ...
        options.request = _GroupUtility["default"].createGroupMetricRequest({
    ...
    _instantiateMetricWidget: function _instantiateMetricWidget(options) {
      ...
      return new Promise(function (resolve) {
        var Ctor = _this.metricWidgetCtor || _MetricWidget["default"];
