define("crm/Views/Charts/GenericPie", ["exports", "dojo/_base/declare", "dojo/_base/array", "dojo/dom-geometry", "argos/View", "./_ChartMixin"], function (_exports, _declare, _array, _domGeometry, _View, _ChartMixin2) {
  "use strict";
   ...
   *
   */
  var __class = (0, _declare["default"])('crm.Views.Charts.GenericPie', [_View["default"], _ChartMixin2["default"]],
  /** @lends module:crm/Views/Charts/GenericPie.prototype */
  {
    ...
    createChart: function createChart(rawData) {
      ...
      var data = _array["default"].map(rawData, function (item, idx) {
        return {
      ...
      var chart = new window.Chart(ctx); // Ensure the chart has the ability to render this type
    ...
    _getItemColor: function _getItemColor(index) {
      ...
      var theIndex = index; // if n is 0, the index will fall within the seriesColor array,
