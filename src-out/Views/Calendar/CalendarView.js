...
define("crm/Views/Calendar/CalendarView", ["exports", "argos/Convert", "dojo/_base/declare", "dojo/_base/lang", "dojo/on", "dojo/string", "dojo/when", "argos/Calendar", "argos/List", "../../Utility", "argos/I18n", "../../Models/Activity/ActivityTypeIcon"], function (_exports, _Convert, _declare, _lang, _on, _string, _when, _Calendar, _List, _Utility, _I18n, activityTypeIcons) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('calendarView');
  var dtFormatResource = (0, _I18n["default"])('calendarViewDateTimeFormat');
  ...
  var __class = (0, _declare["default"])('crm.Views.Calendar.CalendarView', [_List["default"]], {
    ...
    createActivityRows: function createActivityRows() {
      ...
      var day = arguments.length > 1 ? arguments[1] : undefined;
      ...
      if (count > 0) {
        ...
        if (this._showMulti) {
          var headerNode = $(this.headerRowTemplate.apply({
            day: day
          }, this)).get(0); // Create the day header for whatever type comes first (activity or event)
    ...
    formatQueryEvent: function formatQueryEvent(value) {
      ...
      var start = _Convert["default"].toIsoStringFromDate(value.clone().startOf('month').toDate());

      var end = _Convert["default"].toIsoStringFromDate(value.clone().endOf('month').toDate());

      return "UserId eq \"".concat(user, "\" and ((StartDate gt @").concat(start, "@ or EndDate gt @").concat(start, "@) and StartDate lt @").concat(end, "@)");
    },
    ...
    process: function process(store, entries, isEvent) {
      ...
      if (entries.length > 0) {
        entries.forEach(function (entryPreProcess) {
          var entry = _this2._processEntry(entryPreProcess); // If key comes back with nothing, check that the store is properly
    ...
    renderCalendar: function renderCalendar() {
      if (!this._calendar) {
        this._calendar = new _Calendar["default"]({
          id: 'calendar-view__calendar',
          noClearButton: true
        });
        ...
        (0, _on["default"])($(toggle).children()[0], 'click', this.toggleMultiSelect.bind(this));
