...
define('crm/Views/ErrorLog/List', [
    ...
    'argos/ErrorManager',
    'argos/List'
], function (declare, lang, Memory, format, convert, ErrorManager, List) {
    var __class = declare('crm.Views.ErrorLog.List', [List], {
        ...
        createStore: function () {
            ...
            errorItems.sort(function (a, b) {
                ...
                var A = convert.toDateFromString(a.errorDateStamp), B = convert.toDateFromString(b.errorDateStamp);
