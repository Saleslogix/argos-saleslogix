...
define('crm/Views/_GroupListMixin', [
    ...
    'dojo/Deferred',
    '../Action'
], function (declare, string, json, domStyle, domClass, query, domAttr, domConstruct, format, utility, GroupUtility, when, lang, SDataStore, Deferred, action) {
    ...
    __class = declare('crm.Views._GroupListMixin', null, {
        ...
        getDefaultGroup: function () {
            var defaultGroup = null, defaultGroupName = null;
