...
define("crm/Views/Activity/List", ["exports", "dojo/_base/declare", "dojo/_base/connect", "../_RightDrawerListMixin", "argos/List", "argos/Convert", "../../Action", "../../Format", "../../Environment", "argos/ErrorManager", "../../Models/Names", "argos/Models/Types", "argos/I18n", "../../Models/Activity/ActivityTypeIcon", "../../Models/Activity/ActivityTypePicklists", "dojo/string"], function (_exports, _declare, _connect, _RightDrawerListMixin2, _List, _Convert, _Action, _Format, _Environment, _ErrorManager, _Names, _Types, _I18n, activityTypeIcons, _ActivityTypePicklists, _string) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('activityList');
  var hashTagResource = (0, _I18n["default"])('activityListHashTags');

  var __class = (0, _declare["default"])('crm.Views.Activity.List', [_List["default"], _RightDrawerListMixin2["default"]], {
    // Localization
    ...
    hashTagQueries: {
      ...
      yesterday: function computeYesterday() {
        ...
        var query = "((Timeless eq false and StartDate between @".concat(_Convert["default"].toIsoStringFromDate(yesterdayStart.toDate()), "@ and @").concat(_Convert["default"].toIsoStringFromDate(yesterdayEnd.toDate()), "@) or (Timeless eq true and StartDate between @").concat(yesterdayStart.format('YYYY-MM-DDT00:00:00[Z]'), "@ and @").concat(yesterdayEnd.format('YYYY-MM-DDT23:59:59[Z]'), "@))");
        return query;
      },
      today: function computeToday() {
        ...
        var query = "((Timeless eq false and StartDate between @".concat(_Convert["default"].toIsoStringFromDate(todayStart.toDate()), "@ and @").concat(_Convert["default"].toIsoStringFromDate(todayEnd.toDate()), "@) or (Timeless eq true and StartDate between @").concat(todayStart.format('YYYY-MM-DDT00:00:00[Z]'), "@ and @").concat(todayEnd.format('YYYY-MM-DDT23:59:59[Z]'), "@))");
        return query;
      },
      'this-week': function computeThisWeek() {
        ...
        var query = "((Timeless eq false and StartDate between @".concat(_Convert["default"].toIsoStringFromDate(weekStartDate.toDate()), "@ and @").concat(_Convert["default"].toIsoStringFromDate(weekEndDate.toDate()), "@) or (Timeless eq true and StartDate between @").concat(weekStartDate.format('YYYY-MM-DDT00:00:00[Z]'), "@ and @").concat(weekEndDate.format('YYYY-MM-DDT23:59:59[Z]'), "@))");
        return query;
      }
    },
    ...
    recordCallToHistory: function recordCallToHistory(complete, entry) {
      var tempEntry = {
        ...
        Description: _string["default"].substitute(this.calledText, [entry.ContactName || '']),
    ...
    navigateToHistoryInsert: function navigateToHistoryInsert(type, entry, complete) {
      _Action["default"].navigateToHistoryInsert(entry, complete);
    },
