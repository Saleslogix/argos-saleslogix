define("crm/Integrations/BOE/Views/ERPReceivables/Detail", ["exports", "dojo/_base/declare", "dojo/_base/lang", "crm/Format", "argos/Detail", "../../Models/Names", "argos/I18n", "../../Utility"], function (_exports, _declare, _lang, _Format, _Detail, _Names, _I18n, _Utility) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('erpReceivablesDetail');
      ...
      return this.layout || (this.layout = [{
        ...
        children: [{
          ...
          renderer: function renderer(value) {
            return _Utility["default"].formatMultiCurrency(value, _this2.entry.BaseCurrencyCode);
          }
        }, {
          ...
          renderer: function renderer(value) {
            return _Utility["default"].formatMultiCurrency(value, _this2.entry.CurrencyCode);
          }
        }, {
        ...
        children: [{
          ...
          where: function where(entry) {
            return "ErpReceivable.Id eq \"".concat(entry.$key, "\"");
          },
