define("crm/Integrations/BOE/Views/SalesOrderItems/List", ["exports", "dojo/_base/declare", "dojo/_base/lang", "argos/List", "crm/Action", "crm/Format", "crm/Views/_RightDrawerListMixin", "crm/Views/_MetricListMixin", "../../Models/Names", "argos/I18n", "../../Utility", "../Locations/SalesOrderItemAvailabilityList"], function (_exports, _declare, _lang, _List, _Action, _Format, _RightDrawerListMixin2, _MetricListMixin2, _Names, _I18n, _Utility, _SalesOrderItemAvailabilityList) {
  "use strict";
  ...
  _SalesOrderItemAvailabilityList = _interopRequireDefault(_SalesOrderItemAvailabilityList);
   ...
   */
  var resource = (0, _I18n["default"])('salesOrderItemsList');

  var __class = (0, _declare["default"])('crm.Integrations.BOE.Views.SalesOrderItems.List', [_List["default"], _RightDrawerListMixin2["default"], _MetricListMixin2["default"]], {
    ...
    createActionLayout: function createActionLayout() {
      return this.actions || (this.actions = [{
        ...
        enabled: function enabled(layoutAction, selection) {
          return App.warehouseDiscovery === 'auto' && _Action["default"].hasProperty(layoutAction, selection, 'SalesOrder.ErpLogicalId');
        },
    ...
    getAvailabilityView: function getAvailabilityView() {
      ...
      App.registerView(new _SalesOrderItemAvailabilityList["default"]({
        id: viewId
      }));
    ...
    formatSearchQuery: function formatSearchQuery(searchQuery) {
      ...
      return "(upper(Description) like \"".concat(q, "%\") or (upper(ProductName) like \"").concat(q, "%\") or (upper(SalesOrder.SalesOrderNumber) like \"").concat(q, "%\") or (upper(ErpLineNumber) like \"").concat(q, "%\")");
    }
  });
