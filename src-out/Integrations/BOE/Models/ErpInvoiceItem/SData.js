define("crm/Integrations/BOE/Models/ErpInvoiceItem/SData", ["exports", "dojo/_base/declare", "dojo/_base/lang", "./Base", "argos/Models/_SDataModelBase", "argos/Models/Manager", "argos/Models/Types", "../Names"], function (_exports, _declare, _lang, _Base, _SDataModelBase2, _Manager, _Types, _Names) {
  "use strict";
   ...
   */
  var __class = (0, _declare["default"])('crm.Integrations.BOE.Models.ErpInvoiceItem.SData', [_Base["default"], _SDataModelBase2["default"]], {
  ...
  _Manager["default"].register(_Names["default"].ERPINVOICEITEM, _Types["default"].SDATA, __class);

  _lang["default"].setObject('icboe.Models.ErpInvoiceItem.SData', __class);
