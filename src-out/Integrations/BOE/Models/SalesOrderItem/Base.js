define("crm/Integrations/BOE/Models/SalesOrderItem/Base", ["exports", "dojo/_base/declare", "dojo/_base/lang", "argos/Models/_ModelBase", "../Names", "argos/I18n"], function (_exports, _declare, _lang, _ModelBase2, _Names, _I18n) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('salesOrderItemModel');
  var salesorderResource = (0, _I18n["default"])('salesOrderModel');

  var __class = (0, _declare["default"])('crm.Integrations.BOE.Models.SalesOrderItem.Base', [_ModelBase2["default"]], {
  ...
  _lang["default"].setObject('icboe.Models.SalesOrderItem.Base', __class);
