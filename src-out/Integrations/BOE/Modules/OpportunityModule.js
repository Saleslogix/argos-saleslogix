define("crm/Integrations/BOE/Modules/OpportunityModule", ["exports", "dojo/_base/declare", "dojo/_base/lang", "./_Module", "../Views/Quotes/List", "../Views/SalesOrders/List", "../PricingAvailabilityService", "argos/I18n"], function (_exports, _declare, _lang, _Module2, _List, _List2, _PricingAvailabilityService, _I18n) {
  "use strict";
   ...
   */
  var resource = (0, _I18n["default"])('opportunityModule');

  var __class = (0, _declare["default"])('crm.Integrations.BOE.Modules.OpportunityModule', [_Module2["default"]], {
    ...
    loadCustomizations: function loadCustomizations() {
      ...
      _lang["default"].extend(crm.Views.Opportunity.Detail, {
        ...
        opportunityRePrice: function opportunityRePrice() {
          ...
          _PricingAvailabilityService["default"].opportunityRePrice(this.entry).then(function (result) {
        ...
        value: {
          ...
          children: [{
            ...
            where: function where(entry) {
              return "Opportunity.Id eq \"".concat(entry.$key, "\"");
            },
