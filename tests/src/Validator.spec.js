define('spec/Validator.spec', ['Mobile/SalesLogix/Validator'],function(Validator) {
    ...
    describe('Mobile.SalesLogix.Validator exists', function() {
    ...
    describe('Mobile.SalesLogix.Validator name', function() {
    ...
    describe('Mobile.SalesLogix.Validator notEmpty', function() {
    ...
    describe('Mobile.SalesLogix.Validator hasText', function() {
